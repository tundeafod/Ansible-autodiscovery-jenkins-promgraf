...
# sudo chmod +x prom_server_update.sh
# * * * * * /Users/babatundeafodunrinbi/ProjectFolder/Ansible-autodiscovery-jenkins-promgraf/module/monitoring/prom_server_update.sh >/dev/null 2>&1
