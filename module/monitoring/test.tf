...
# target_port="9100"
# sleep_duration=60
# SSH_KEY_PATH="/home/your_username/.ssh/id_rsa"  # Change 'your_username' to your actual username
...
#                 scp ubuntu@local_machine:"$private_ip_file" /tmp/  # Replace 'local_machine' with your actual hostname or IP
